		...
		value: function getAllOfType(type, includeAllSubTypes, callback) {
			...
			if (this.loadedDeep) {
				...
				types.forEach(function (t) {
					if (_this6.loadedTypes[t] && Object.getOwnPropertyNames(_this6.loadedTypes[t]).length !== 0) {
						for (var _oid in _this6.loadedTypes[t]) {
							callback(_this6.loadedTypes[t][_oid]);
						}
					} else {
						query.queries.push({
							type: t
					...
					this.bimServerApi.getJsonStreamingSerializer(function (serializer) {
						_this6.bimServerApi.call("ServiceInterface", "download", {
							...
							_this6.bimServerApi.getJson(url, null, function (data) {
								data.objects.forEach(function (object) {
									if (!_this6.loadedTypes[object._t]) {
										_this6.loadedTypes[object._t] = {};
									}

									if (_this6.objects[object._i]) {
										...
										if (wrapper.isA(object._t)) {
											_this6.loadedTypes[object._t][object._i] = wrapper;
											callback(wrapper);
										}
									} else {
										...
										if (object._s == 1) {
											_this6.loadedTypes[object._t][object._i] = _wrapper;
											callback(_wrapper);
										}
									}
								});
...
var BimServerClient = function () {
	...
	createClass(BimServerClient, [{
		...
		value: function init(callback) {
			...
			var promise = new Promise(function (resolve, reject) {
				_this.call("AdminInterface", "getServerInfo", {}, function (serverInfo) {
		...
		key: 'clearBinaryDataListener',
		value: function clearBinaryDataListener(topicId) {
		...
		value: function getJsonSerializer(callback) {
			this.getSerializerByPluginClassName("org.bimserver.serializers.JsonSerializerPlugin").then(function (serializer) {
				callback(serializer);
			});
		}
	}, {
		...
		value: function getJsonStreamingSerializer(callback) {
			this.getSerializerByPluginClassName("org.bimserver.serializers.JsonStreamingSerializerPlugin").then(function (serializer) {
				callback(serializer);
			});
		}
	}, {
		key: 'getMinimalJsonStreamingSerializer',
		value: function getMinimalJsonStreamingSerializer(callback) {
			this.getSerializerByPluginClassName("org.bimserver.serializers.MinimalJsonStreamingSerializerPlugin").then(function (serializer) {
				callback(serializer);
			});
		}
	}, {
		key: 'getSerializerByPluginClassName',
		value: function getSerializerByPluginClassName(pluginClassName) {
			var _this6 = this;
			...
			if (this.serializersByPluginClassName[pluginClassName] != null) {
				...
				var promise = new Promise(function (resolve, reject) {
					_this6.call("PluginInterface", "getSerializerByPluginClassName", {
		...
		value: function callWithNoIndication(interfaceName, methodName, data, callback, errorCallback) {
		...
		key: 'initiateCheckin',
		value: function initiateCheckin(project, deserializerOid, callback, errorCallback) {
		...
		key: 'callWithWebsocket',
		value: function callWithWebsocket(interfaceName, methodName, data) {
			var _this21 = this;

			var promise = new Promise(function (resolve, reject) {
				var id = _this21.idCounter++;
				_this21.websocketCalls.set(id, function (response) {
				...
				if (_this21.token != null) {
					request.token = _this21.token;
				}
				_this21.webSocket.send(request);
			});
			return promise;
		}
...
exports.BimServerClient = BimServerClient;
